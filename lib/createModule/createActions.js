...
var _generateActions = function _generateActions(generatedActions, transformation) {
  ...
  generatedActions[camelizedActionName] = (0, _reduxActions.createAction)(actionName, (0, _payloadPropchecker2.default)({ actionName: actionName, payloadTypes: payloadTypes, onError: onError }));
